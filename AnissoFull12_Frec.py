...
def plot_horizontal_angles_cwt(results, cwt_scale=10):
    ...
    # Add colorbar
    plt.colorbar(im, ax=axes1, location='bottom', pad=0.05, label='CWT Magnitude')
    ...
    # Add colorbar
    plt.colorbar(im, ax=axes2, location='bottom', pad=0.05, label='CWT Magnitude')
    ...
    # Add colorbar
    plt.colorbar(im, ax=axes3, location='bottom', pad=0.05, label='CWT Magnitude Difference')
...
def display_results(results, seismic_cmap, selected_angle):
    ...
    # 5. Horizontal Arrangement of CWT Analysis (NEW)
    ...
    cwt_results = plot_horizontal_angles_cwt(results, cwt_scale)
    ...
    plt.colorbar(im, ax=ax4, label='Reflectivity Difference')
    st.pyplot(fig4)
