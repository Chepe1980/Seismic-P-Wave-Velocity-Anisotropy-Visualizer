...
epsilon = st.sidebar.slider("ε (Epsilon)", -0.5, 0.5, 0.01, 0.01, 
                           help="Controls the 'stretch' of the velocity ellipse")
delta = st.sidebar.slider("δ (Delta)", -0.5, 0.5, 0.01, 0.01,  
                         help="Affects curvature near the axes")
gamma = st.sidebar.slider("γ (Gamma)", -0.5, 0.5, 0.01, 0.01, 
